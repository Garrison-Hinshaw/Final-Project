...
export default function NewProduct(PRODUCTS) {
  ...
  return (
    ...
    <div class="card">
      ...
      <div class="card-body">
        <h5 class="card-title">Teal Shirt</h5>
        <p class="card-text">
          Price: $8.00
        </p>
        <p class="card-text">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <h5 class="card-title">Navy Shirt</h5>
        <p class="card-text">
          Price: $8.50
        </p>
        <p class="card-text">
    ...
    <div class="card-group-2">
      <div class="card">
        ...
        <div class="card-body">
          <h5 class="card-title">Spidey Man Action Figure</h5>
          <p class="card-text">
           Price: $12.50
          </p>
          <p class="card-text">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <h5 class="card-title">Remote Control Drone</h5>
          <p class="card-text">
           Price: $150.00
          </p>
          <p class="card-text">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <h5 class="card-title">Iron Man Action Figure</h5>
          <p class="card-text">
            Price: $16.50
          </p>
          <p class="card-text">
